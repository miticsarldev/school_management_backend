...
exports.authenticateToken = exports.verifyPassword = exports.hashPassword = exports.generateRefreshToken = exports.generateAccessToken = void 0;
var jsonwebtoken_1 = require("jsonwebtoken");
var bcryptjs_1 = require("bcryptjs");
var generateAccessToken = function (email) {
    return jsonwebtoken_1.default.sign({ email: email }, process.env.ACCESS_TOKEN_SECRET, {
        expiresIn: "15m",
    });
};
exports.generateAccessToken = generateAccessToken;
var generateRefreshToken = function (email) {
    return jsonwebtoken_1.default.sign({ email: email }, process.env.REFRESH_TOKEN_SECRET, {
